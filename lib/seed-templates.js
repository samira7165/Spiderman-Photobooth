...
// each template's prompt is edited independently from the admin
// dashboard — there is no shared/master prompt. When a guest
// picks a template, the AI receives exactly that template's
// prompt + reference image, plus the guest's own photo.
// =============================================================
